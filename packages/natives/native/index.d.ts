...
export declare class Process {
  ...
  static fromPid(pid: unknown): Process | null
 ...
 */
export declare function __piNativesV0_9_6(): void
...
export declare function captureProcessIdentity(pid: unknown): ProcessIdentityCapture
 ...
 */
export declare function classifyStrictFs(fd: unknown): StrictFsResult
...
export declare function compareProcessIdentity(pid: unknown, identity: string): ProcessIdentityComparison
...
export interface ProcessIdentityCapture {
  state: string
  identity?: string
  diagnostic?: ProcessIdentityDiagnostic
}

export interface ProcessIdentityComparison {
  state: string
  diagnostic?: ProcessIdentityDiagnostic
}

export interface ProcessIdentityDiagnostic {
  code: string
  errno?: number
}
...
export interface StrictFsDiagnostic {
  code: string
  errno?: number
}

export interface StrictFsResult {
  state: string
  platform?: string
  f_fstypename?: string
  fsid?: string
  diagnostic?: StrictFsDiagnostic
}
